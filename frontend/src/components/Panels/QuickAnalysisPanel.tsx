...
export default function QuickAnalysisPanel() {
  ...
  return (
    <motion.aside
      ...
      exit={{ opacity: 0, x: 24 }}
      className="absolute z-40 max-sm:inset-x-3 max-sm:bottom-24 max-sm:max-h-[58dvh] sm:right-20 sm:top-20 sm:bottom-36 sm:w-80 overflow-y-auto rounded-2xl bg-surface/95 backdrop-blur ring-1 ring-line shadow-panel p-4 space-y-4"
    >
