...
export default function BatchPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <motion.aside
      ...
      className="absolute z-30 max-sm:inset-x-3 max-sm:bottom-24 max-sm:max-h-[58dvh] sm:right-20 sm:top-20 sm:bottom-36 sm:w-96 overflow-y-auto rounded-2xl bg-surface/95 backdrop-blur ring-1 ring-line shadow-panel p-4 space-y-3"
    >
